  ...
  if (loading) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center">
        <div className="w-8 h-8 border-3 border-gray-200 border-t-[#1a2b49] rounded-full animate-spin"></div>
      </div>
    );
  }
      ...
      <div className="bg-gray-50 min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
        <div className="bg-white border border-gray-100 rounded-2xl p-8 max-w-md w-full text-center">
          <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mx-auto mb-5">
            <AlertCircle className="w-8 h-8 text-[#1a73e8]" />
          </div>
          <h2 className="text-xl font-bold text-[#1a2b49] mb-2">Already Reviewed</h2>
          ...
          <button onClick={() => navigate('/dashboard')} className="px-6 py-2.5 bg-[#1a2b49] text-white rounded-lg text-sm font-semibold hover:bg-[#0f1d35] transition-colors">
            Back to Dashboard
          </button>
        </div>
      </div>
    ...
    return (
      <div className="bg-gray-50 min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
        <div className="bg-white border border-gray-100 rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-bold text-[#1a2b49] mb-2">Thank You!</h2>
    ...
    <div className="bg-gray-50 min-h-[calc(100vh-64px)]">
      <div className="max-w-lg mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-br from-[#1a2b49] to-[#2d4a7a] p-6 text-center text-white">
          ...
          <div className="p-6 space-y-6">
            ...
            {specialist && (
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  <h3 className="font-semibold text-[#1a2b49]">{specialist.name}</h3>
                  <p className="text-xs text-[#1a73e8] font-medium">{specialist.category} Specialist</p>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full border border-gray-200 rounded-xl p-4 text-sm focus:outline-none focus:border-[#1a73e8] focus:ring-1 focus:ring-[#1a73e8]/20 resize-none"
            ...
            <button
              ...
              disabled={submitting}
              className="w-full py-3 bg-[#1a2b49] text-white rounded-xl font-semibold text-sm hover:bg-[#0f1d35] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              className="w-full py-2.5 text-gray-500 text-sm font-medium hover:text-[#1a2b49] transition-colors"
            >
              Skip for now
            </button>
          </div>
